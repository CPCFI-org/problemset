...
void solve(){
    ...
    int ans = ( dp[targetSum] * 500000004) % MOD; //Modulo inverso de 2 debido a que como lo computamos con modulo, se trabaja diferente
    cout<<ans;
}
